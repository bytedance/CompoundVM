...
#define VM_CLASSES_DO(do_klass)                                                                                 \
  ...
  do_klass(ConcurrentHashMap_ForwardingNode_klass,      java_util_concurrent_ConcurrentHashMap_ForwardingNode ) \
...
#else // defined(HOTSPOT_TARGET_CLASSLIB) && HOTSPOT_TARGET_CLASSLIB == 8
