...
public class ReferenceRefersTo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PhantomReference<Object> pref = new PhantomReference<>(obj0, queue);
        WeakReference<Object> wref = new WeakReference<>(obj1);
        SoftReference<Object> sref = new SoftReference<>(obj2);
