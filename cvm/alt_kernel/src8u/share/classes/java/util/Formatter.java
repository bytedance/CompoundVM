 ...
 *
 * <p>
 * For category <i>General</i>, <i>Character</i>, <i>Numeric</i>,
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'h'}, {@code 'H'}
 * <td style="vertical-align:top">general
 * <td>The result is obtained by invoking
 * {@code Integer.toHexString(arg.hashCode())}.
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 's'}, {@code 'S'}
 * <td style="vertical-align:top">general
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 't'}, {@code 'T'}
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code '%'}
 * <td style="vertical-align:top">percent
 * <td>The result is a literal {@code '%'} (<code>'&#92;u0025'</code>)
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'n'}
 ...
 * <tbody>
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'H'}
 * <td>Hour of the day for the 24-hour clock, formatted as two digits with
 * a leading zero as necessary i.e. {@code 00 - 23}.
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'I'}
 * <td>Hour for the 12-hour clock, formatted as two digits with a leading
 * zero as necessary, i.e. {@code 01 - 12}.
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'k'}
 * <td>Hour of the day for the 24-hour clock, i.e. {@code 0 - 23}.
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'l'}
 * <td>Hour for the 12-hour clock, i.e. {@code 1 - 12}.
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'M'}
 * <td>Minute within the hour formatted as two digits with a leading zero
 * as necessary, i.e. {@code 00 - 59}.
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'S'}
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'p'}
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'z'}
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'Q'}
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'B'}
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'A'}
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'j'}
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'e'}
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'R'}
 * <td>Time formatted for the 24-hour clock as {@code "%tH:%tM"}
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'T'}
 ...
 * <thead>
 * <tr>
 * <th scope="col" style="vertical-align:bottom">Flag
 * <th scope="col" style="vertical-align:bottom">General
 * <th scope="col" style="vertical-align:bottom">Character
 * <th scope="col" style="vertical-align:bottom">Integral
 ...
 * <tr>
 * <th scope="row">'#'
 * <td style="text-align:center; vertical-align:top">y<sup>1</sup>
 ...
 *
 * <p>
 * Values of <i>precision</i> must be in the range zero to
 * {@link Integer#MAX_VALUE}, inclusive, otherwise
 * {@link IllegalFormatPrecisionException} is thrown.
 * </p>
 *
 * <p>
 * Values of <i>width</i> must be in the range one to
 * {@link Integer#MAX_VALUE}, inclusive, otherwise
 ...
 * <i>width</i> is <i>20</i> and the <i>flag</i> is "-".
 * </p>
 *
 * <p>
 * Values of <i>index</i> must be in the range one to
 * {@link Integer#MAX_VALUE}, inclusive, otherwise
 ...
 *
 * <p>
 * The following <a id="dFlags">flags</a> apply to general conversions:
 *
 * <table class="striped">
 ...
 *
 * <p>
 * The <a id="genWidth">width</a> is the minimum number of characters to
 * be written to the
 * output. If the length of the converted value is less than the width then
 * the output will be padded by <code>'&nbsp;&nbsp;'</code>
 * (<code>'&#92;u0020'</code>)
 ...
 *
 * <p>
 * <b><a id="L10nAlgorithm"> Number Localization Algorithm</a></b>
 *
 * <p>
 ...
 *
 * <p>
 * <a id="dnint"><b> Byte, Short, Integer, and Long </b></a>
 *
 * <p>
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'x'}
 ...
 *
 * <p>
 * The following <a id="intFlags">flags</a> apply to numeric integral
 * conversions:
 *
 * <table class="striped">
 ...
 *
 * <p>
 * If both the {@code '+'} and <code>'&nbsp;&nbsp;'</code> flags are given
 * then an {@link IllegalFormatFlagsException} will be thrown.
 *
 * <tr>
 * <th scope="row" style="vertical-align:top"><code>'&nbsp;&nbsp;'</code>
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code '0'}
 ...
 *
 * <p>
 * If no <a id="intdFlags">flags</a> are given the default formatting is
 * as follows:
 *
 * <ul>
 *
 ...
 *
 * <p>
 * The <a id="intWidth">width</a> is the minimum number of characters to
 * be written to the output. This includes any signs, digits, grouping
 * separators, radix indicator, and parentheses. If the length of the
 * converted value is less than the width then the output will be padded by
 * spaces (<code>'&#92;u0020'</code>) until the total number of characters
 * equals
 ...
 *
 * <p>
 * <a id="dndec"><b> Float and Double</b></a>
 *
 * <p>
 ...
 *
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'g'}
 ...
 *
 * <p>
 * If no <a id="floatdFlags">flags</a> are given the default formatting
 * is as follows:
 *
 * <ul>
 *
 ...
 *
 * <p>
 * The <a id="floatDWidth">width</a> is the minimum number of characters
 * to be written to the output. This includes any signs, digits, grouping
 * separators, decimal separators, exponential symbol, radix indicator,
 * parentheses, and strings representing infinity and NaN as applicable. If
 * the length of the converted value is less than the width then the output
 * will be padded by spaces (<code>'&#92;u0020'</code>) until the total number
 * of
 ...
 *
 * <p>
 * If the <a id="floatDPrec">conversion</a> is {@code 'e'},
 ...
 * <tr>
 * <th scope="row" style="vertical-align:top">{@code 'Y'}
 * <td style="vertical-align:top"><code>'&#92;u0059'</code>
 * <td>Year, formatted to at least
 ...
 * (<code>'&#92;u0020'</code>) until the total number of characters equals
 * width.
...
public final class Formatter implements Closeable, Flushable {
     ...
     *
     * @throws FileNotFoundException
     *                                      If the given file name does not denote
     ...
     *
     * @throws IOException
     *                              if an I/O error occurs while opening or creating
     *                              the file
     *
     * @throws SecurityException
     *                              If a security manager is present and {@link
     *                              SecurityManager#checkWrite checkWrite(fileName)}
     *                              denies write
     *                              access to the file
     *
     * @throws NullPointerException
     *                              if {@code fileName} or {@code charset} is
     *                              {@code null}.
     */
     ...
     *                               If a security manager is present and {@link
     *                               SecurityManager#checkWrite
     *                               checkWrite(file.getPath())} denies
     ...
     *
     * @throws FileNotFoundException
     *                                      If the given file object does not denote
     *                                      an existing, writable
     *                                      regular file and a new regular file of
     *                                      that name cannot be
     *                                      created, or if some other error occurs
     ...
     *                                   negative, or if {@code beginIndex} is
     *                                   greater than
     *                                   {@code endIndex} or if {@code endIndex} is
     *                                   greater than
     *                                   {@code s.length()}.
     * @throws NumberFormatException     if the {@code CharSequence} does not
     *                                   contain a parsable {@code int} in the
     *                                   specified
     *                                   {@code radix}, or if {@code radix} is
     *                                   either smaller than
    ...
    static int parseInt(CharSequence s, int beginIndex, int endIndex, int radix)
        ...
        if (digit >= 0 || digit == ~0xFF && endIndex - beginIndex > 1) {
            ...
            while (i < endIndex && (digit = Character.digit(s.charAt(i++), radix)) >= 0
    ...
    private class FormatSpecifier implements FormatString {
        ...
        private void index(String s, int start, int end) {
            if (start >= 0) {
                try {
                    // skip the trailing '$'
                    index = parseInt(s, start, end - 1, 10);
                    if (index <= 0) {
        ...
        private void precision(String s, int start, int end) {
            if (start >= 0) {
                try {
                    // skip the leading '.'
                    precision = parseInt(s, start + 1, end, 10);
                    if (precision < 0)
        ...
        private String toUpperCaseWithLocale(String s, Locale l) {
            return s.toUpperCase(requireNonNullElse(l,
        ...
        private Appendable print(StringBuilder sb, Calendar t, char c, Locale l)
            ...
            switch (c) {
                ...
                case DateTime.AM_PM: { // 'p' (am or pm)
                    ...
                    sb.append(s.toLowerCase(requireNonNullElse(l,
                            Locale.getDefault(Locale.Category.FORMAT))));
                    break;
                }
                ...
                case DateTime.ZONE: { // 'Z' (symbol)
                    ...
                    sb.append(tz.getDisplayName((t.get(Calendar.DST_OFFSET) != 0),
                            TimeZone.SHORT,
                            requireNonNullElse(l, Locale.US)));
                    break;
                }
                ...
                case DateTime.NAME_OF_DAY: { // 'A'
                    ...
                    Locale lt = requireNonNullElse(l, Locale.US);
