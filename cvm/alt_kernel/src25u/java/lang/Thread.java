...
/*
    ...
    Thread(ThreadGroup g, String name, int characteristics, Runnable task, long stackSize) {
        ...
        if (attached && jdk.internal.misc.VM.initLevel() < 1) {
...
*/
     ...
     */
    State threadState() {
        return sun.misc.VM.toThreadState(holder.threadStatus);
    }
    ...
    private static class Constants {
        ...
        static {
            ...
            VTHREAD_GROUP = null; //new ThreadGroup(root, "VirtualThreads", MAX_PRIORITY, false);
        }
    }
